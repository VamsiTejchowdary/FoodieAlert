...
/* harmony reexport (unknown) */ __webpack_require__.d(__webpack_exports__, __WEBPACK_REEXPORT_OBJECT__);
    ...
    const tree = {
        ...
        {
        children: ['__PAGE__', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 75613)), "/Users/vamsitejchowdary/Documents/GitHub/FoodieAlert/app/dashboard/page.jsx"],
    ...
    manifest: undefined
        ...
        {
          'layout': [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 62050)), "/Users/vamsitejchowdary/Documents/GitHub/FoodieAlert/app/layout.js"],
          metadata: {
    icon: [(async (props) => (await Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 57481))).default(props))],
    apple: [],
    openGraph: [],
    ...
    const pages = ["/Users/vamsitejchowdary/Documents/GitHub/FoodieAlert/app/dashboard/page.jsx"];
...
Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 48781))
...
function UserInfo() {
    ...
    const [businessAddress, setBusinessAddress] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)(""); // Input field for Business Location
    (0,react__WEBPACK_IMPORTED_MODULE_1__.useEffect)(()=>{
        ...
        if (session?.user?.email) {
            ...
            const resUserExists = async ()=>{
                try {
                    ...
                    react_toastify__WEBPACK_IMPORTED_MODULE_3__/* .toast */ .Am.error("Error fetching user data.");
        ...
        session,
        status
    ]); // Dependency array to re-run when session or status changes
    const fetchLocations = async (business_id)=>{
        try {
            const response = await fetch(`/api/locations?business_id=${business_id}`, {
                method: "GET",
                headers: {
                    "Content-Type": "application/json"
                }
            ...
            react_toastify__WEBPACK_IMPORTED_MODULE_3__/* .toast */ .Am.error("Error fetching locations.");
            console.error("Error fetching locations:", error);
        }
    };
    const addNewLocation = async ()=>{
        if (user.status !== "approved") {
            react_toastify__WEBPACK_IMPORTED_MODULE_3__/* .toast */ .Am.warning("You cannot add a location until your account is approved.");
            return;
        }
        try {
            ...
            if (res.ok) {
                react_toastify__WEBPACK_IMPORTED_MODULE_3__/* .toast */ .Am.success("Location added successfully!");
                setBusinessName("");
                setBusinessAddress("");
                setIsModalOpen(false);
                fetchLocations(user?._id); // Refresh locations
            } else {
                react_toastify__WEBPACK_IMPORTED_MODULE_3__/* .toast */ .Am.error("Failed to add location.");
            }
        } catch (error) {
            react_toastify__WEBPACK_IMPORTED_MODULE_3__/* .toast */ .Am.error("An error occurred while adding the location.");
        ...
        children: [
            ...
            /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
                ...
                children: [
                                ...
                                /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("p", {
                                    ...
                                    children: [
                                        ...
                                        /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("span", {
                                            className: `${user?.status === "approved" ? "text-green-500" : user?.status === "pending" ? "text-yellow-500" : "text-red-500"} font-bold`,
                                            children: user?.status || "Unknown"
                                        })
                                    ]
                                })
                            ]
                    ...
                    user?.status === "approved" && /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
                        children: [
                            /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("h2", {
                                className: "text-xl font-semibold text-gray-800 mb-4",
                                children: "Locations"
                            }),
                            locations.length > 0 ? /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("ul", {
                                className: "list-disc pl-6 space-y-2",
                                children: locations.map((location, index)=>/*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("li", {
                    ...
                    /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("button", {
                        ...
                        className: `w-full px-6 py-3 rounded-lg text-white font-semibold ${user?.status === "approved" ? "bg-blue-600 hover:bg-blue-700" : "bg-gray-300 text-gray-500 cursor-not-allowed"} transition duration-300 ease-in-out transform hover:scale-105`,
...
const proxy = (0,module_proxy.createProxy)(String.raw`/Users/vamsitejchowdary/Documents/GitHub/FoodieAlert/components/UserInfo.jsx`)
...
/* harmony default export */ const UserInfo = (__default__);
;// CONCATENATED MODULE: ./app/dashboard/page.jsx


function Dashboard() {
    return /*#__PURE__*/ jsx_runtime_.jsx(UserInfo, {});
}
